                    ...
                    <?php
                        if(isset($_GET['error'])){
                            if($_GET['error'] == "invalidusername&email"){
                                echo '<p class="msg-error">Pseudo et email invalides</p>';
                            }else if($_GET['error'] == "invalidemail"){
                                    echo '<p class="msg-error">email invalid</p>';
                                }else if($_GET['error'] == "invalidusername"){
                                        echo '<p class="msg-error">Username invalid</p>';
                                    }else if($_GET['error'] == "PWDdontmatch"){
                                        echo '<p class="msg-error">Les mots de passe ne correspondent pas</p>';
                                }else if($_GET['error'] == "USERNAMETAKEN"){
                                        echo '<p class="msg-error">Username déjà pris!</p>';
                                    }
